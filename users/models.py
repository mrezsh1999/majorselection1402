...
class Student(User):
    ...
    is_state_final_approval = models.BooleanField(default=False)
    ...
    f_count = models.IntegerField(null=True, blank=True, default=0)
    f_percentage = models.FloatField(null=True, blank=True, default=0)
    i_count = models.IntegerField(null=True, blank=True, default=0)
    i_percentage = models.FloatField(null=True, blank=True, default=0)
    e_count = models.IntegerField(null=True, blank=True, default=0)
    e_percentage = models.FloatField(null=True, blank=True, default=0)
    j_count = models.IntegerField(null=True, blank=True, default=0)
    j_percentage = models.FloatField(null=True, blank=True, default=0)
    n_count = models.IntegerField(null=True, blank=True, default=0)
    n_percentage = models.FloatField(null=True, blank=True, default=0)
    p_count = models.IntegerField(null=True, blank=True, default=0)
    p_percentage = models.FloatField(null=True, blank=True, default=0)
    s_count = models.IntegerField(null=True, blank=True, default=0)
    s_percentage = models.FloatField(null=True, blank=True, default=0)
    t_count = models.IntegerField(null=True, blank=True, default=0)
    t_percentage = models.FloatField(null=True, blank=True, default=0)
