...
router.register(r'select_province_for_major',
                SelectProvinceForMajorViewSet, 'select_province_for_major')
router.register(r'select_province',
                SelectDefaultProvinceViewSet, 'select_province')
